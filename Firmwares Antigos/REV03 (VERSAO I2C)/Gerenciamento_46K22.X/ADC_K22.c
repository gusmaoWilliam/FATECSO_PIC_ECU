...
void Config_ADC(void) //Configuração dos registradores pertencentes ao ADC
{
    ...
    ANSELAbits.ANSA0 = nAnalog_Pin; //Battery Analog Input   AN0
    ANSELAbits.ANSA1 = nAnalog_Pin; //Pedal1 Analog Input   AN1
    //ANSELAbits.ANSA2 = nAnalog_Pin;         //Pedal2 Analog Input   AN2
    ANSELAbits.ANSA3 = nAnalog_Pin; //Lambda1 Analog Input  AN3
    ...
    //ANSELBbits.ANSB5 = nAnalog_Pin;         //Pressão Analog Input  AN13

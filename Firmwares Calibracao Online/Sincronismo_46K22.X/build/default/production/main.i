...
# 137
int ij14_pos, ij23_pos;

# 145
long long periodo_peralta, t_periodo, t_periodo_ref;

# 148
int volta14, volta23;
int estado_controle_ml = 0;


int ig_tmr_disparo, ig_tmr_disparo_controle;

# 154
int ig_dente_23, ig_dente_23_ant;
int ig_dente_14, ig_dente_14_ant;

long ij_tmr_disparo;

# 159
float Erro_RPM = 0, Erro_RPM_ant = 0, u = 0, teto_avanco = 21, u_ant = 0, SP_rpm = 1000, ig_tmr_disparo_controle_temp;
float K = 0.24546, z = 0.8921, dente_controle = 0, kp_inj = 1.0;
...
bit Enable_control_ign = 0;
bit Chave_controle_geral = 0;
...
I2C_Leitura_Multiplos_Endereco(0x30, 11, 0x60);
Flag_I2c = 1;
}
...
{
ig_tmr_disparo = buffer_read[8];
}




ij_tmr_disparo = 65535 - Make_16(buffer_read[5], buffer_read[6]);
tempo_bob = buffer_read[7];
tempo_inj = 65535 - Make_16(buffer_read[1], buffer_read[2]);

rotacao = rotacao_peralta / 100;
ij_dente_14_extra = buffer_read[9];
ij_dente_23_extra = ij_dente_14_extra + 30;
Set_Vent = buffer_read[10];
estado_controle_ml = buffer_read[3];
...
if (rotacao > 65 || fase_ok == 0) return;
if (PORTBbits.RB1 == 0) return;
...
TRISD = 0b00000000;
TRISE = 0b00000100;
_delay((unsigned long)((50)*(40000000/4000000.0)));
...
dente_controle = u / 6;
dente_controle = 14 - dente_controle;
n_controle = 10000 / periodo_peralta;
dente_subida = dente_controle - n_controle;
...
ig_tmr_disparo_controle_temp = ig_tmr_disparo_controle << 1;

if (ig_tmr_disparo_controle_temp < 10.0)
{
ig_tmr_disparo_controle_temp = 10.0;
}
ig_tmr_disparo_controle_temp = ig_tmr_disparo_controle_temp / 52;

if (ig_tmr_disparo_controle_temp < 1)
{

ig_tmr_disparo_controle_temp = 1.0;
}
...
void Control_ml_ign(void)
{
Erro_RPM = SP_rpm - rotacao_peralta;
